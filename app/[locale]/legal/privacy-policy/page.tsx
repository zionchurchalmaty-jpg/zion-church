...
export const metadata: Metadata = {
  title: "Privacy Policy - Церкось Сион",
  description: "Privacy Policy for Церкось Сион website and services.",
};
    ...
    <main className="min-h-screen bg-cream">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            Церкось Сион (&ldquo;GNBC,&rdquo; &ldquo;we,&rdquo;
            &ldquo;us,&rdquo; or &ldquo;our&rdquo;), located at 20430 Ashburn
            Village Blvd, Ashburn, VA 20147, is committed to protecting your
            ...
            , or use our mobile application (collectively, the
          ...
          <p>
            ...
            mailing address, family information, date of birth, profile photos,
          ...
          <p>
            When you make donations or payments, your financial information
            (such as credit card numbers and bank account details) is processed
            directly by our third-party payment processor, Stripe. We do not
            store your complete payment card information on our servers. Please
            review Stripe&apos;s privacy policy for information about how they
            handle your data.
          </p>
          ...
          <p>
            ...
            without parental consent. Parents may provide information about
            their children when registering for Sunday School, youth programs,
            or other children&apos;s ministries. If you believe we have
          ...
          <ul>
            <li>
              To facilitate church membership, ministry participation, and
              spiritual care
            </li>
          ...
          <p>
            We use third-party services to operate our ministry, including
            Planning Center (church management), Stripe (payment processing),
            Google (analytics and advertising), YouTube (video hosting), and
            social media platforms. These providers have access to your
            information only as necessary to perform their services.
          </p>

          <h3>4.2 Church Leadership and Ministries</h3>

          <p>
            Information may be shared with pastors, deacons, and ministry
            leaders as necessary for pastoral care, ministry coordination, and
            church operations. Prayer requests may be shared with prayer team
            members unless you request confidentiality.
          </p>

          <h3>4.3 Church Directory</h3>

          <p>
            With your consent, basic contact information may be included in our
            church directory, accessible only to registered church members.
          </p>
          ...
          <p>
            ...
            protect the rights, safety, or property of GNBC, our members, or
            others.
          </p>
          ...
          <p>
            ...
            experience, analyze usage patterns, and deliver targeted advertising
            through Google Ads. You can control cookie settings through your
            browser preferences. Please note that disabling cookies may affect
          ...
          <p>
            ...
            retained as required by tax regulations.
          </p>
          ...
          <p>
            ...
            social media platforms (Facebook, Instagram, YouTube, X). We are not
          ...
          <p>
            ...
            to review this policy periodically. Your continued use of our
