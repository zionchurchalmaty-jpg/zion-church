        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="flex items-center gap-3">
              <img src="/GNBC_logo.png" alt="Good News Bible Church" className="h-10 md:h-12 w-auto" />
            </div>
            ...
            <div className="hidden lg:flex items-center gap-8">
              ...
              <div className="flex items-center gap-1 bg-gray-100 rounded-full p-1">
                ...
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-medium transition-all ${
                    language === "ru" ? "bg-primary text-white" : "text-gray-600"
                  }`}
                >
                  RU
                </button>
              ...
              <Button size="sm" className="bg-primary hover:bg-[rgb(var(--primary-orange-hover))]">
                Give
              </Button>
            </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
          ...
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8 animate-fade-in">
            ...
            <span className="text-sm text-white font-medium">Join us this Sunday at 1:30 PM</span>
          </div>
          ...
          <p className="text-lg sm:text-xl text-white/80 mb-8 max-w-3xl mx-auto animate-fade-in-up animation-delay-200 leading-relaxed">
            A bilingual Russian-English Bible church in Ashburn, Virginia serving the Slavic community and beyond.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-10 text-white animate-fade-in-up animation-delay-300">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm sm:text-base">20430 Ashburn Village Blvd, Ashburn, VA</span>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up animation-delay-400">
            <Button size="lg" className="bg-primary hover:bg-[rgb(var(--primary-orange-hover))] text-white px-8">
              Plan Your Visit
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-xl">
              ...
              />
              <p className="mt-4 text-sm text-gray-700 text-center">Our church family</p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-lg leading-relaxed text-gray-700">
                <p>
                  We are a family of believers from Russia, Ukraine, the former Soviet Union, and America — united by
                  faith in Jesus Christ. Our bilingual services in Russian and English welcome immigrants, their
                  families, and all who seek authentic community, spiritual growth, and opportunities to serve together.
                </p>
                <p>
                  Whether you're a new immigrant or have called this area home for years, you'll find a warm, welcoming
                  community ready to embrace you and walk alongside you in your faith journey.
                </p>
              </div>

              <div className="bg-cream border-l-4 border-primary p-6 rounded-lg">
                <p className="font-serif text-xl text-navy font-medium">"Bring God's Joy to All People"</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-4">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="h-px w-12 bg-primary" />
              <span className="text-sm font-semibold text-navy uppercase tracking-wider">Your First Visit</span>
              <div className="h-px w-12 bg-primary" />
            </div>
            <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy mb-4 text-balance">What to Expect</h2>
            ...
            {[
              ...
              >
                ...
                <CardContent className="pt-6">
                  <h3 className="font-semibold text-xl mb-2 text-navy">{feature.title}</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Services are approximately 90 minutes</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Check className="size-5 text-primary shrink-0 mt-0.5" />
                    <span className="text-gray-700">Casual dress is welcome – come as you are</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <Check className="size-5 text-primary shrink-0 mt-0.5" />
                    <span className="text-gray-700">Translation available for Russian and English</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <Check className="size-5 text-primary shrink-0 mt-0.5" />
      ...
      <section id="ministries" className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-4">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="h-px w-12 bg-primary" />
              <span className="text-sm font-semibold text-navy uppercase tracking-wider">Get Involved</span>
              <div className="h-px w-12 bg-primary" />
            </div>
            <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy mb-4 text-balance">Our Ministries</h2>
            <p className="text-lg text-gray-700 max-w-2xl mx-auto">Connect, grow, and serve our community and family</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            {[
              ...
              },
              {
                icon: Users,
                title: "Youth & Teens",
                description: "Friday night gatherings for grades 6-12 with games, worship, and real conversations",
                image: "/youth-teens-church-group.jpg",
              },
              {
                icon: GraduationCap,
                title: "ESL Classes",
                description: '"English with Joy" — Learn English in a welcoming, supportive environment',
                image: "/english-class-teaching-esl.jpg",
              },
              {
                icon: Globe,
                title: "Missions",
                description: "Serving communities in Kazakhstan and beyond through short-term mission trips",
                image: "/mission-trip-service-helping.jpg",
              },
              {
                icon: ShoppingCart,
                title: "Practical Help",
                description: "Supporting families in need with groceries and essential supplies",
                image: "/food-pantry-helping-groceries.jpg",
              },
              {
                icon: Mountain,
                title: "Picnics & Retreats",
                description: "Church picnics, family getaways, and outdoor fellowship events throughout the year",
                image: "/church-picnic-outdoor-nature.jpg",
              },
            ].map((ministry, index) => (
              <Card key={index} className="bg-cream hover:shadow-md transition-all duration-300 group overflow-hidden">
                <div className="relative h-48 overflow-hidden">
                  <img
                ...
                <CardContent className="py-6">
                  <h3 className="font-semibold text-xl mb-2 text-navy">{ministry.title}</h3>
      ...
      <section id="gallery" className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="h-px w-12 bg-primary" />
              <span className="text-sm font-semibold text-navy uppercase tracking-wider">Our Community</span>
              <div className="h-px w-12 bg-primary" />
            </div>
            <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy mb-4 text-balance">Church Life</h2>
            <p className="text-lg text-gray-700">Moments of worship, fellowship, and service</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            {[
              ...
              { span: "", label: "Youth Night", image: "/youth-group-teens.jpg" },
              {
                span: "",
                label: "Church Picnic",
              ...
              <div key={index} className={`relative group overflow-hidden rounded-xl ${item.span}`}>
            ...
            <div>
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-px w-12 bg-primary" />
                  <span className="text-sm font-semibold text-navy uppercase tracking-wider">Visit Us</span>
                  <div className="h-px w-12 bg-primary" />
                </div>
                <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy mb-4 text-balance">Find Us</h2>
                <p className="text-lg text-gray-700">We'd love to see you this Sunday</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-navy mb-1">Address</h3>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-navy mb-1">Service Times</h3>
                    <p className="text-gray-700">Sunday Worship: 1:30 PM</p>
                    <p className="text-gray-700">Wednesday Bible Study: 7:00 PM</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-navy mb-1">Contact</h3>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="h-px w-12 bg-primary" />
              <span className="text-sm font-semibold text-navy uppercase tracking-wider">Got Questions?</span>
              <div className="h-px w-12 bg-primary" />
            </div>
            <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy mb-4 text-balance">
              Frequently Asked Questions
            </h2>
            <p className="text-lg text-gray-700">Everything you want to know about our church</p>
          </div>

          <div className="grid lg:grid-cols-3 gap-12">
            {/* Left Column - Text */}
            <div className="lg:col-span-1 space-y-6">
              <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy text-balance">Common Questions</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
                We know visiting a new church can bring questions. Here are answers to some of the most common ones.
              </p>
              <Card className="bg-cream border-none">
                <CardContent className="py-6">
                  <p className="font-medium text-navy mb-2">Still have questions?</p>
              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1" className="border rounded-lg px-6 bg-white">
                  ...
                  <AccordionContent className="text-gray-700 leading-relaxed pb-4">
                    Our services are bilingual! Sermons alternate between Russian and English, with translation always
                    available. Worship songs include both languages so everyone can participate.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-2" className="border rounded-lg px-6 bg-white">
                  ...
                  <AccordionContent className="text-gray-700 leading-relaxed pb-4">
                    Yes! We offer Sunday School for children ages 3-13 during the main service. We also have Friday
                ...
                <AccordionItem value="item-3" className="border rounded-lg px-6 bg-white">
                  ...
                  <AccordionContent className="text-gray-700 leading-relaxed pb-4">
                    We are a nondenominational Bible church. Our focus is on Scripture, the Gospel of Jesus Christ, and
                ...
                <AccordionItem value="item-4" className="border rounded-lg px-6 bg-white">
                  ...
                  <AccordionContent className="text-gray-700 leading-relaxed pb-4">
                    Join one of our Home Groups meeting throughout Northern Virginia, or simply stay for coffee after
                    the service — we'd love to introduce you to others!
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
      ...
      <section className="py-20 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="h-px w-12 bg-primary" />
              <span className="text-sm font-semibold text-primary uppercase tracking-wider">Stay Connected</span>
              <div className="h-px w-12 bg-primary" />
            </div>
            <h2 className="font-serif font-bold text-4xl md:text-5xl text-navy mb-4 text-balance">
              Join Our Community
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Follow us on social media and subscribe to our newsletter for updates, encouragement, and event
              announcements.
            </p>
          </div>
                ...
                <CardContent className="py-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-xl mb-1 text-navy">@goodnewsbibleorg</h3>
                      <p className="text-gray-600 mb-4 leading-relaxed">
                        Follow us for daily encouragement, event photos, and community highlights
                      </p>
                      <Button
                        asChild
                        className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600"
                      >
                        <a href="https://www.instagram.com/goodnewsbibleorg/" target="_blank" rel="noopener noreferrer">
                          Follow on Instagram
                        </a>
                      </Button>
                    </div>
              ...
              <Card className="bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                <CardContent className="py-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-xl mb-1 text-navy">Good News Bible Church</h3>
                      <p className="text-gray-600 mb-4 leading-relaxed">
                        Join our Facebook community for events, livestreams, and discussions
                      </p>
                      <Button asChild className="bg-blue-600 hover:bg-blue-700">
                        <a href="https://www.facebook.com/goodnewsbibleorg" target="_blank" rel="noopener noreferrer">
                          Like on Facebook
                        </a>
                      </Button>
                    </div>
              ...
              <Card className="bg-white hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                <CardContent className="py-8">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-xl mb-1 text-navy">Good News Bible Church YT</h3>
                      <p className="text-gray-600 mb-4 leading-relaxed">
                        Watch sermons, worship sessions, and teachings on our YouTube channel
                      </p>
            ...
            <Card className="bg-white border-2 border-primary/20">
              <CardContent className="py-8">
                <div className="text-center mb-6">
                  ...
                  <h3 className="font-serif font-semibold text-2xl mb-2 text-navy">Subscribe to Our Newsletter</h3>
                  <p className="text-gray-600 leading-relaxed">
                    Get weekly updates, sermon highlights, and event announcements delivered to your inbox.
                  </p>
                </div>
                ...
                <form className="space-y-4">
                  ...
                  <Button type="submit" className="w-full bg-primary hover:bg-[rgb(var(--primary-orange-hover))] h-12">
                    Subscribe
                  </Button>
                  <p className="text-xs text-gray-600 text-center">We respect your privacy. Unsubscribe anytime.</p>
                </form>
              </CardContent>
            </Card>
          </div>
      ...
      >
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-white/80">Planning to visit or have a question? Drop us a message.</p>
          </div>
            ...
            <CardContent className="py-8">
              <form className="space-y-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg space-y-3">
                  <p className="text-sm font-medium text-gray-700 mb-2">I'm interested in:</p>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" className="size-4 text-primary rounded border-gray-300 focus:ring-primary" />
                    <span className="text-gray-700">I'm planning to visit this Sunday</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" className="size-4 text-primary rounded border-gray-300 focus:ring-primary" />
                    <span className="text-gray-700">I'd like to learn about ESL classes</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input type="checkbox" className="size-4 text-primary rounded border-gray-300 focus:ring-primary" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div className="font-serif font-semibold text-lg">Good News Bible Church</div>
              </div>
              <p className="font-serif text-white/80">Bring God's Joy to All People</p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-white/80">
                ...
                <li>
                  <a href="#ministries" className="hover:text-primary transition-colors">
                    Ministries
                  </a>
                </li>
                <li>
